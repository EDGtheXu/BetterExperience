...
public abstract class AbstractJsonConfig {
    ...
    protected abstract JsonObject defaultConfig(RegistryAccess registryAccess);
     ...
     * Server
     */
    public void loadConfig(RegistryAccess registryAccess){
        ...
        try {
            ...
            if (!file.exists()) {
                ...
                json = defaultConfig(registryAccess);
