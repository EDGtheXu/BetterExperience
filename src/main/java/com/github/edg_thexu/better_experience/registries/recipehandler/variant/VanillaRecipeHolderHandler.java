 ...
 */
public record VanillaRecipeHolderHandler(ResourceLocation location) implements IRecipeHandler<Ingredient> {

    public static MapCodec<VanillaRecipeHolderHandler> CODEC = ResourceLocation.CODEC.xmap(VanillaRecipeHolderHandler::new, VanillaRecipeHolderHandler::location).fieldOf("handler");
